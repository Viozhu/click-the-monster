          ...
          new THREE.RawShaderMaterial({
            ...
            fragmentShader: `
              ...
              void main(void) {
                ...
                float opacity = (96.0 - distance) / 256.0 * 0.7;
                
                // Create colorful gradient based on position and time
                float hue = (vPosition.y * 0.01 + vTime * 0.1) * 0.3 + 0.5;
                float saturation = 0.7 + sin(vPosition.x * 0.02 + vTime) * 0.3;
                float brightness = 0.8 + sin(distance * 0.05 + vTime * 0.5) * 0.2;
                
                vec3 hsv = vec3(hue, saturation, brightness);
                vec3 color = hsv2rgb(hsv);
                
                // Add some sparkle effect
                float sparkle = sin(vPosition.x * 0.5 + vTime * 2.0) * sin(vPosition.y * 0.5 + vTime * 2.0);
                color += sparkle * 0.1;
